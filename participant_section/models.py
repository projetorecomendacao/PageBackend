...
class Participant(models.Model):
    ...
    p01_name_social = models.CharField('Nome:', max_length=50, null=True, blank=True)
...
#    address = models.ForeignKey(Address, on_delete=models.DO_NOTHING, related_name='participant_situations')
    p02_address = models.CharField("Endereço", max_length=100 )
    p03_communication = models.CharField('Meios de Entrar em contato', max_length=100)
    ...
    p11_retire_more_time_activity = models.CharField('Se aposentado, qual profissão exerceu por mais tempo', max_length=100, null=True, blank='True')
    ...
    p15_religion = models.CharField('Religião', max_length=100, null=True, blank=True)
