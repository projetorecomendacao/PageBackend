...
class FunctionalDisabilityUsp (models.Model):
    ...
    q27_useTelephone = models.CharField(OptionsUsp.questions[23],  max_length=1, default="N", choices=OptionsUsp.CHOICES)
    q28_dress_up = models.CharField(OptionsUsp.questions[24],  max_length=1, default="N", choices=OptionsUsp.CHOICES)
    q29_takeShower = models.CharField(OptionsUsp.questions[25],  max_length=1, default="N", choices=OptionsUsp.CHOICES)
    comments = models.TextField("Observações",null=True, blank=True)
    need_investigation = models.CharField(OptionsUsp.need_investigation_question,max_length=1, default="N",choices=OptionsUsp.CHOICES)
    max_score = models.IntegerField(default=6)
    score = models.IntegerField(null=True)
...
class MalnutritionUsp (models.Model):
    ...
    d33_lost_weight_no_reason = models.CharField(OptionsUsp.questions[33], max_length=1, default="N", choices=OptionsUsp.CHOICES)
    d33_lost_weight_no_reason_amount = models.CharField(OptionsUsp.questions[33], max_length=15, default="N", choices=OptionsUsp.LOSTWEIGHT)
...
class CardiovascularFactorsUsp (models.Model):
    ...
    q37_hypertension_unknow = models.CharField(OptionsUsp.questions[34][0], max_length=1, default="N", choices=OptionsUsp.CHOICES, null=True, blank=True)
    q38_uncontrolled_diabetes_unknow = models.CharField(OptionsUsp.questions[34][0], max_length=1, default="N", choices=OptionsUsp.CHOICES, null=True, blank=True)
    q39_cholesterol_unknow = models.CharField(OptionsUsp.questions[34][0], max_length=1, default="N", choices=OptionsUsp.CHOICES, null=True, blank=True)
