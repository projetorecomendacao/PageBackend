...
class CardiovascularFactorsUsp (models.Model):
    ...
    q37_hypertension_unknow = models.CharField(OptionsUsp.questions[34][0], max_length=1, default="N", choices=OptionsUsp.CHOICES)
    q38_uncontrolled_diabetes_unknow = models.CharField(OptionsUsp.questions[34][0], max_length=1, default="N", choices=OptionsUsp.CHOICES)
    q39_cholesterol_unknow = models.CharField(OptionsUsp.questions[34][0], max_length=1, default="N", choices=OptionsUsp.CHOICES)
